    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Purchased_Ticket", x => new { x.CustomerId, x.TicketConcertId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Concert 1" },
                    { 2, 7, new DateTime(2024, 5, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Concert 2" },
                    { 3, 10, new DateTime(2024, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Concert 3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, new DateTime(2024, 5, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 3, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Purchased_Ticket_TicketConcertId",
                table: "Purchased_Ticket",
